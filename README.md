...
<ol>
    <li> Configurar um banco de dados (SGBD <em>PostgreSQL</em>)</li>
    <li> Aplicar as <em>annotations</em></li>
    <li> Executar o fluxo back-end: <em>Controller - Service - Repository</em></li>
    <li> Colocar em prática a validação com - <em>Hibernate Validator</em> </li>
    <li> Executar consultas avançadas com - <em>Derived Query - Native Query</em></li>
</ol>
